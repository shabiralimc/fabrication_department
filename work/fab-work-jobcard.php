...
$sqlnew = "SELECT jm.jc_number, jm.jc_date,jm.client,jm.involvements, jm.work_jc, jm.completion_before, jm.csr, jm.jc_status, fm.fab_status
FROM jobcard_main jm
LEFT JOIN fabrication_main fm ON jm.jc_number = fm.jc_number AND fam_branch LIKE '%$userbranch%'
WHERE jm.involvements LIKE '%$userbranch%' AND jm.work_jc = 'work_jc' AND fm.fab_status IS NULL  AND jm.jc_status != 'cancelled'";

$resultnew = mysqli_query($conn, $sqlnew);

// WIP JOBS SQL QUERY
$sqlwip = "SELECT jm.jc_number, jm.jc_date,jm.client,jm.involvements, jm.work_jc, jm.completion_before, jm.jc_status, jm.csr, fm.fab_status
FROM jobcard_main jm
LEFT JOIN fabrication_main fm ON jm.jc_number = fm.jc_number AND fam_branch LIKE '%$userbranch%'
WHERE jm.involvements LIKE '%$userbranch%' AND jm.work_jc = 'work_jc' AND fm.fab_status = 'wip' AND jm.jc_status != 'cancelled'";

$resultwip = mysqli_query($conn, $sqlwip);

// COMPLETED JOBS SQL QUERY
$sqlcom = "SELECT jm.jc_number, jm.jc_date,jm.client,jm.involvements, jm.work_jc, jm.completion_before, jm.jc_status, jm.csr, fm.fab_status
FROM jobcard_main jm
LEFT JOIN fabrication_main fm ON jm.jc_number = fm.jc_number AND fam_branch LIKE '%$userbranch%'
WHERE jm.involvements LIKE '%$userbranch%' AND jm.work_jc = 'work_jc' AND fm.fab_status = 'completed' AND jm.jc_status != 'cancelled'";

$resultcom = mysqli_query($conn, $sqlcom);

// ALL JOBS SQL QUERY
$sqlall = "SELECT jm.jc_number, jm.jc_date,jm.client,jm.involvements, jm.work_jc, jm.completion_before, jm.jc_status, jm.csr, fm.fab_status
FROM jobcard_main jm
LEFT JOIN fabrication_main fm ON jm.jc_number = fm.jc_number AND fam_branch LIKE '%$userbranch%'
WHERE jm.involvements LIKE '%$userbranch%' AND jm.work_jc = 'work_jc' AND jm.jc_status != 'cancelled'";
            ...
            <div class="card-body">
              <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-one-newjob" role="tabpanel" aria-labelledby="custom-tabs-one-newjob-tab">
                  ...
                  <table id="fabricationTablenew" class="table table-bordered table-striped" style="width:100%">
                    <thead>
                    ...
                    <tbody>
                      ...
                      <tr style="text-align: center;">
                        ...
                        <?php if ($row['fab_status'] == "completed") {
                          echo '<td style="width: 10%"><a href="fab-work-report.php?jc_number='.$row['jc_number'].'"class="btn btn-warning"><i class="fas fa-print"></i> Report</a></td>';
                        } else {
                          echo '<td style="width: 10%"><button class="btn btn-warning disabled"><i class="fas fa-print"></i> Report</a></button></td>';
                        }
                        ?>

                        <td style="width: 10%"><a href="fab-work-edit.php?jc_number=<?php echo $row['jc_number'];?>"class="btn btn-primary"><i class='fas fa-edit'></i> Edit JC</a></td>
                        <td style="width: 10%"><a href="fab-work-view.php?jc_number=<?php echo $row['jc_number'];?>"class="btn btn-info"><i class="fas fa-search"></i> View</a></td>
                  ...
                  <table id="fabricationTablecom" class="table table-bordered table-striped"style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr style="text-align: center;">
                        ...
                        <?php if ($row['fab_status'] == "completed") {
                          echo '<td style="width: 10%"><a href="#" class="btn btn-primary disabled"><i class="fas fa-edit"></i> Edit JC</a></td>';
                        } else {
                          echo '<td style="width: 10%"><a href="fab-work-edit.php?jc_number='.$row['jc_number'].'" class="btn btn-primary"><i class="fas fa-edit"></i> Edit JC</a></td>';
                        }
                        ?>
                  ...
                  <table id="fabricationTableall" class="table table-bordered table-striped"style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr style="text-align: center;">
                        ...
                        <?php if ($row['fab_status'] == "completed" || $row['fab_status'] == "wip") {
                          echo '<td style="width: 10%"><a href="fab-work-report.php?jc_number='.$row['jc_number'].'"class="btn btn-warning"><i class="fas fa-print"></i> Report</a></td>';
                        } else {
                          echo '<td style="width: 10%"><button class="btn btn-warning disabled"><i class="fas fa-print"></i> Report</a></button></td>';
                        }
                        ...
                        <?php if ($row['fab_status'] == "completed" && $row > 0) {
